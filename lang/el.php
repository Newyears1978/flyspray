...
'projectkey'              => 'Κλειδί έργου',
'emptyprojectkey'		  => 'Το κλειδί του έργου πρέπει να αποτελείται από κεφαλαία γράμματα και τουλάχιστον 2 με ανώτατο όριο 10 χαρακτήρες εκ των οποίων το πρώτο πρέπει να είναι γράμμα.',
'projectkeyhint1'		  => 'To κλειδί έργου χρησιμοποιείται ως πρόθεμα τις κάθε εργασίας στο έργο.',
'projectkeyhint2'		  => 'Μπορεί να αλλάξει αλλά δεν συνισταται.',
);
