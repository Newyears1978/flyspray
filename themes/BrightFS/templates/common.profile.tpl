<?php echo tpl_form( $do=='myprofile' ? Filters::noXSS(CreateUrl('myprofile')) : Filters::noXSS(CreateUrl('edituser', $theuser->id))); ?>
    <ul class="form_elements">
      ...
      <li>
        ...
        <select class="s2" id="notifytype" name="notify_type">
      ...
      <li>
        ...
        <select class="s2" name="tasks_perpage" id="tasks_perpage">
      ...
      <li>
        ...
        <select id="groupin" class="s2" name="group_in" <?php echo tpl_disableif(!$user->perms('is_admin')); ?>>
      ...
      <li>
        ...
        <select id="projectgroupin" class="s2" name="project_group_in" <?php echo tpl_disableif(!$user->perms('manage_project')); ?>>
      ...
      <li>
        ...
        <button class="ggl button blue" type="submit"><?php echo Filters::noXSS(L('updatedetails')); ?></button>
      </li>
    </ul>
  </form>
