    <form action="<?php echo Filters::noXSS($baseurl); ?>index.php" method="get" id="groupselect">
        <div>
            ...
            <select class="s2" name="id" id="selectgroup"><?php echo tpl_options(Flyspray::ListGroups($proj->id), Req::num('id')); ?></select>
...
<table class="box">
      ...
      <tr>
        ...
        <td><select class="s2" name="move_to">
      ...
      <tr>
        <td colspan="2" class="buttons">
          ...
          <button class="ggl button green" type="submit"><?php echo Filters::noXSS(L('updatedetails')); ?></button>
        </td>
      </tr>
    </table>
</fieldset>
...
<fieldset>
    ...
    <table id="manage_users_in_groups" class="table table-striped table-bordered table-hover">
    <thead>
    <tr>
      <th>
    ...
    <tr>
    <td colspan="4">
        <button class="ggl button blue" type="submit"><?php echo Filters::noXSS(L('moveuserstogroup')); ?></button>
        <select class="s2 adminlist" name="switch_to_group">
          <?php if ($proj->id): ?>
