...
<?php echo tpl_form(Filters::noXSS(CreateUrl('newmultitasks', $proj->id, $supertask_id))); ?>
  ...
  <button class="ggl button gray" accesskey="f" type="button" onClick="Apply()"><?php echo L('applyfirstline'); ?></button>
  <table class="list">
    <thead>
       <tr>
	<th></th>
	...
	<td style="display:none">
	<?php } ?>
            <select class="s2" id="severity" class="adminlist" name="task_severity[]">
	...
	<td>
      ...
      <tr>
        <td class="buttons" colspan="<?php echo $field_num; ?>">
          <button class="ggl button blue" accesskey="a" type="button" onClick="createRow('','')"><?php echo L('addmorerows'); ?></button>
          <button class="ggl button green" accesskey="s" type="submit"><?php echo L('addtasks'); ?></button>
        </td>
      </tr>
     </tbody>
  </table>
