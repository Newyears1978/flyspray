...
<tr>
    ...
    <td title="<?php echo Filters::noXSS(L('ordertip')); ?>">
      ...
      <td title="<?php echo Filters::noXSS(L('listtensetip')); ?>">
        <select class="s2" id="tense<?php echo Filters::noXSS($countlines); ?>" name="<?php echo Filters::noXSS($list_type); ?>_tense[<?php echo Filters::noXSS($row[$list_type.'_id']); ?>]">
...
<tr>
      ...
      <?php if ($list_type == 'version'): ?>
      <td title="<?php echo Filters::noXSS(L('listtensetip')); ?>">
        <select class="s2" id="tensenew" name="<?php echo Filters::noXSS($list_type); ?>_tense">
      ...
      <td class="buttons">
        <input type="hidden" name="project" value="<?php echo Filters::noXSS($proj->id); ?>" />
        <button type="submit" class="ggl button green"><?php echo Filters::noXSS(L('addnew')); ?></button>
      </td>
    </tr>
</tbody>
</table>
