...
<div id="toolbox">
   ...
   <div id="general" class="tab">
      <ul class="form_elements">
        ...
        <li>
          ...
          <select class="s2" id="defaultproject" name="default_project">
        ...
        <li>
          ...
          <select class="s2" id="urlrewriting" name="url_rewriting">
        ...
        <li>
          ...
          <select class="s2" id="dateformat" name="dateformat">
        ...
        <li>
          ...
          <select class="s2" id="dateformat_extended" name="dateformat_extended">
        ...
        <li>
          ...
          <select class="s2" id="cache_feeds" name="cache_feeds">
        ...
        <li>
          <label class="labeltextarea" for="intromesg"><?php echo Filters::noXSS(L('mainmessage')); ?></label>
			<?php
			echo $brightFS->dokuwiki('intro_message', 'intromesg', 8, Post::val('intro_message', $fs->prefs['intro_message']), (defined('FLYSPRAY_HAS_PREVIEW') ? 'preview' : null), $baseurl);
			?>
        </li>
      </ul>
    </div>
	...
	<li>
        ...
        <li>
          ...
          <select class="s2" id="defaultglobalgroup" name="anon_group">
    ...
    <div id="notifications" class="tab">
      <ul class="form_elements">
        <li>
          ...
          <select class="s2" id="usernotify" name="user_notify">
  ...
  <?php echo Filters::noXSS(L('testmailsettings')); ?>: <button class="ggl button gray" onclick="testEmail();return false;"><?php echo Filters::noXSS(L('test')); ?></button><div id="emailresult" style="display:inline-block;"></div> <?php echo Filters::noXSS(L('testmailsettingsnotice')); ?>.
<script>
function testEmail(){
      ...
      <fieldset><legend><?php echo Filters::noXSS(L('jabbernotify')); ?></legend>
        <ul class="form_elements">
          <li>
            ...
            <?php if(extension_loaded('openssl')) : ?>
              <select class="s2" id="jabber_ssl" name="jabber_ssl">
    ...
    <div id="lookandfeel" class="tab">
      <ul class="form_elements">
			...
			<select class="s2" id="globaltheme" name="global_theme">
	...
	require_once(BASEDIR . '/themes/BrightFS/class.BrightFS.php');
	$brightFS = new BrightFS();
	echo $brightFS->dokuwiki('general_integration', 'general_integration', 8, Post::val('general_integration', $fs->prefs['general_integration']), (defined('FLYSPRAY_HAS_PREVIEW') ? 'general_preview' : null), $baseurl);
	?>
	</li>
	<?php endif; ?>
	...
	<?php
	echo $brightFS->dokuwiki('footer_integration', 'footer_integration', 8, Post::val('footer_integration', $fs->prefs['footer_integration']), (defined('FLYSPRAY_HAS_PREVIEW') ? 'footer_preview' : null), $baseurl);
	?>
	</li>
	<?php endif; ?>
