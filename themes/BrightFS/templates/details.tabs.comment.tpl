		...
		<div class="comment_container">
			...
			<div class="comment">
				...
				<div class="commenttext">
					...
					echo $brightFS->dokuwiki('comment_text', 'comment_text', 10, Req::val('detailed_desc', $proj->prefs['default_task']), (defined('FLYSPRAY_HAS_PREVIEW') ? 'preview' : null), $baseurl);
					?>
					...
					<div id="addlinkbox">
						...
						<span style="display: none">
							...
							<a href="javascript://" class="ggl button red" tabindex="9" onclick="removeLinkField(this, 'addlinkbox');"><i class="fa fa-remove fa-lg"></i></a><br />
						</span>
						<noscript>
							<span>
								<input tabindex="8" class="text" type="text" size="28" maxlength="100" name="userlink[]" />
					...
					<?php if ($user->perms('create_attachments')): ?>
						<div id="uploadfilebox">
							...
							<button class="ggl button gray" style="display: none; width:100%;" id="uploadfilebox_attachanotherfile" tabindex="7" type="button" onclick="addUploadFields()">
							...
							<span style="display: none;"><!-- this span is shown/copied in javascript when adding files -->
								...
								<a href="javascript://" class="ggl button red" tabindex="6" onclick="removeUploadField(this);"><i class="fa fa-remove fa-lg"></i></a><br />
							</span>
							<noscript>
								<span>
									<input tabindex="5" class="file" type="file" size="55" name="userfile[]" />
					...
					<?php endif; ?>
					<p style="clear:both; margin-bottom:0; margin-top: 10px; float:right;"><button class="ggl button green" accesskey="s" tabindex="9" type="submit"><?php echo Filters::noXSS(L('addcomment')); ?></button></p>
					</form>
				</div>
			</div>
		</div>
