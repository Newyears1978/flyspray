...
if ($do == 'admin') { ?>
	<ul class="form_elements">
		...
		<li>
			...
			<select class="s2" id="notify_type" name="notify_type">
		...
		<li>
			...
			<select class="s2" id="time_zone" name="time_zone">
			<?php
				$times = array();
				for ($i = -12; $i <= 13; $i++) {
		...
		<li>
			...
			<select id="groupin" class="s2" name="group_in">
	...
	<p><button class="ggl button green" type="submit" id="buSubmit"><?php echo Filters::noXSS(L('registeraccount')); ?></button></p>
<?php } else { ?>
	...
	<div class="login-wrap">
		<div class="login-html">
			<input id="tab-2" type="radio" name="tab" class="sign-up"><label <?php if (!$fs->prefs['anon_reg'] && !$fs->prefs['only_oauth_reg']) { echo ' style="display: none"'; } ?> for="tab-2" class="tab"><?php echo Filters::noXSS(L('register')); ?></label>
			<div class="login-form">
				<div class="sign-up-htm">
					...
					<div class="group">
						...
						<input id="pass" name="user_pass" type="password" class="input" data-type="password" value="<?php echo Filters::noXSS(Req::val('user_pass')); ?>" />
					</div>
					<div class="group">
						<label for="pass" class="label">Repeat Password</label>
						<input id="pass" name="user_pass2" type="password" class="input" data-type="password" value="<?php echo Filters::noXSS(Req::val('user_pass2')); ?>" />
					</div>
					<?php } ?>
					<div class="group">
					...
					<div class="group">
						<label for="jabberid" class="label"><?php echo Filters::noXSS(L('jabberid')); ?></label>
						<input id="jabberid" name="jabberid" type="text" class="input" value="<?php echo Filters::noXSS(Req::val('jabber_id')); ?>">
					</div>
					<?php } ?>
					<div class="group">
						<style>
					...
					<div class="group">
						<input type="hidden" name="action" value="register.newuser" />
						<input type="submit" class="ggl button blue" value="<?php echo Filters::noXSS(L('registeraccount')); ?>">
					</div>
				</div>
			</div>
		</div>
