<div id="toolbox">
  ...
  <div id="users_tab" class="tab">
    <a class="ggl button gray" href="<?php echo Filters::noXSS(CreateURL('admin', 'newuser', $proj->id)); ?>"><i class="good fa fa-user-plus fa-lg fa-fw"></i><?php echo L('newuser'); ?></a>
    <a class="ggl button gray" href="<?php echo Filters::noXSS(CreateURL('admin', 'newuserbulk', $proj->id)); ?>"><i class="good fa fa-user-times fa-lg fa-fw"></i><?php echo L('newuserbulk'); ?></a>
    <a class="ggl button gray" href="<?php echo Filters::noXSS(CreateURL('admin', 'editallusers', $proj->id)); ?>"><i class="fa fa-group fa-lg fa-fw"></i><?php echo L('editallusers'); ?></a>
    <div class="groupedit">
<!--
...
-->
      <form action="<?php echo Filters::noXSS($baseurl); ?>index.php" method="get">
              ...
              <button class="ggl button gray" type="submit"><?php echo Filters::noXSS(L('edit')); ?></button>
              <input type="hidden" name="do" value="admin" />
...
<div><a class="ggl button gray" href="<?php echo Filters::noXSS(CreateURL('admin', 'newgroup', $proj->id)); ?>"><i class="fa fa-group fa-lg fa-fw"></i> <?php echo Filters::noXSS(L('newgroup')); ?></a></div>
...
foreach ($groups as $group){
	...
	$gnames  .='<td><a class="ggl button blue" style="height: auto; " title="'.eL('editgroup').'" href="'.( Filters::noXSS(CreateURL('editgroup', $group['group_id'], 'admin'))).'">'.$group['group_name']
