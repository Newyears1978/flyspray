...
<?php echo tpl_form(Filters::noXSS(CreateUrl('newtask', $proj->id, $supertask_id)), 'newtask', 'post', 'multipart/form-data', 'onsubmit="return checkContent()"'); ?>
  ...
  <div id="taskdetails">
      <div id="taskfields">
        <ul class="form_elements slim">
          ...
          <?php } ?>
            ...
            <select class="s2" name="task_type" id="tasktype">
          ...
          <?php } ?>
            ...
            <select class="s2" name="product_category" id="category">
          ...
          <?php } ?>
            ...
            <select class="s2" onchange="getElementById('edit_summary').className = 'summary severity' + this.value;
          ...
          <?php } ?>
            ...
            <select class="s2" name="product_version" id="reportedver">
	...
	<div id="taskdetailsfull">
		...
		<input id="itemsummary" placeholder="<?php echo Filters::noXSS(L('summary')); ?>" title="<?php echo Filters::noXSS(L('tooltipshorttasktitle'));?>" type="text" value="<?php echo Filters::noXSS(Req::val('item_summary')); ?>" name="item_summary" maxlength="100" />
		<div id="edit_tags">
			<label for="tags" title="<?php echo Filters::noXSS(L('tagsinfo'));?>"><?php echo Filters::noXSS(L('tags')); ?>:</label>
			<input id="tags" title="<?php echo Filters::noXSS(L('tagsinfo'));?>" class="text" type="text" value="<?php echo Filters::noXSS(Req::val('tags')); ?>" name="tags" maxlength="100" />
		</div>
		
		  <?php
		  require_once(BASEDIR . '/themes/BrightFS/class.BrightFS.php');
		  $brightFS = new BrightFS();
		  echo $brightFS->dokuwiki('detailed_desc', 'details', 15, Req::val('detailed_desc', $proj->prefs['default_task']), (defined('FLYSPRAY_HAS_PREVIEW') ? 'preview' : null), $baseurl);
		  ?>
		...
		<div class="row">
			<div id="addlinkbox">
				...
				<button class="ggl button gray" style="display: none; width:100%;" id="addlinkbox_addanotherlink" tabindex="10" type="button" onclick="addLinkField('addlinkbox')">
			...
			<div id="uploadfilebox">
				<button class="ggl button gray" style="width:100%;" id="uploadfilebox_attachafile" tabindex="7" type="button" onclick="addUploadFields('uploadfilebox')">
				...
				<button class="ggl button gray" style="display: none; width:100%;" id="uploadfilebox_attachanotherfile" tabindex="7" type="button" onclick="addUploadFields('uploadfilebox')">
				...
				<span style="display: none"><?php // this span is shown/copied in javascript when adding files ?>
					...
					<a href="javascript://" class="ggl button red" title="<?php echo Filters::noXSS(L('remove')); ?>" tabindex="6" onclick="removeUploadField(this, 'uploadfilebox');"><i class="fa fa-remove fa-lg"></i></a><br />
				</span>
				<noscript>
					<span>
						<input tabindex="5" class="file" type="file" size="55" name="userfile[]" />
		...
		<?php endif; ?>
		<div class="row">
			<button class="ggl button green" style="display:block;margin-top:20px" accesskey="s" type="submit"><?php echo Filters::noXSS(L('addthistask')); ?></button>
		</div>
	</div>
